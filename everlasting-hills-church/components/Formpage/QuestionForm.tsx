...
export default function QuestionForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      await apiClient.post("/forms/question", {
  ...
  if (submitted) {
    return (
      <div className="space-y-5 mt-5 flex flex-col items-center justify-center py-12 text-center gap-4">
        ...
        <h3 className="text-xl font-bold text-white">Question received</h3>

        <p className="text-white/60 max-w-sm leading-relaxed">
          Your question has been submitted. Our team will get back to you soon.
        </p>
      </div>
    );
  }
