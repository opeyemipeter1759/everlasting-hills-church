...
export default function RegisterButton({ onClick, registering, registered }: RegisterButtonProps) {
  return (
    <button
      ...
      className={`inline-flex min-w-[7rem] flex-1 items-center justify-center gap-2 rounded-lg px-2 py-2.5 text-xs font-bold transition-all duration-200 disabled:cursor-not-allowed ${
        registered
