        ...
        {TAB_CONFIG.map(({ key, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-1.5 whitespace-nowrap rounded-full px-3 py-2 text-xs font-bold transition-colors duration-200 sm:gap-2 sm:px-5 sm:py-2.5 sm:text-sm ${
