  ...
  return (
    <div className="relative w-full sm:w-64">
      ...
      <input
        ...
        className="w-full rounded-full bg-white/3 border border-white/8 px-10 py-2 text-sm text-white/90 placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-church-maroon"
      />
    </div>
  );
}
