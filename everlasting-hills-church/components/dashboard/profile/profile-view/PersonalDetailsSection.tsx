    ...
    <section aria-labelledby="personal-section-label">
      <ScrollReveal>
        <div className="flex items-center gap-3 mb-5">
          <h2 id="personal-section-label" className="text-[#87102C] dark:text-white/40 text-xs tracking-[0.1em] xs:tracking-[0.2em] uppercase font-semibold flex-shrink-0">
            Personal details
          </h2>
        ...
        {profile.household && (
          <div className="sm:col-span-2 lg:col-span-3">
            <ScrollReveal delay={0.2} className="h-full">
              <div className="group bg-white dark:bg-white/[0.05] border border-[#E7CDD3]/60 dark:border-white/[0.09] rounded-2xl p-4 xs:p-6
                ...
                <div>
                  <p className="text-[10px] tracking-[0.1em] xs:tracking-[0.2em] uppercase font-semibold text-[#87102C] dark:text-[#FFB3C1] mb-1">Household</p>
