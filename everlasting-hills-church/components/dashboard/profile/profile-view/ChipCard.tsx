...
export function ChipCard({
  ...
  return (
    <div
      className={`group bg-white dark:bg-white/[0.05] border border-[#E7CDD3]/60 dark:border-white/[0.09] rounded-2xl p-4 xs:p-6
    ...
    >
      ...
      <div className="flex-1">
        <p className="text-[10px] tracking-[0.1em] xs:tracking-[0.2em] uppercase font-semibold text-[#87102C] dark:text-[#FFB3C1] mb-1.5">
          {label}
        </p>
