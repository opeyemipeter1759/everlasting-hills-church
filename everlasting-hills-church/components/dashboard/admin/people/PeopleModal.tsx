...
/** Reusable centered modal shell with backdrop, escape-to-close, brand styling. */
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className={`w-full ${maxWidth} max-h-[88vh] flex flex-col rounded-2xl bg-white dark:bg-[#140b10] border border-[#E7CDD3]/60 dark:border-white/10 shadow-2xl overflow-hidden`}
          >
