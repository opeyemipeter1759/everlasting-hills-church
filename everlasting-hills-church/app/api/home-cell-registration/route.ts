    ...
    await resend.emails.send({
      ...
      html: `
        ...
        <head>
          ...
          <style>body, table, td, p, a { font-family: Arial, Helvetica, sans-serif; }</style>
        </head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 20px rgba(0,0,0,0.06);">
                  ...
                  <tr>
                    <td style="padding:40px 40px 32px;">
                      <p style="margin:0 0 20px;font-size:11pt;color:#1a1a1a;line-height:1.6;">Dear <strong>${name}</strong>,</p>

                      <p style="margin:0 0 18px;font-size:11pt;color:#333;line-height:1.75;">
                      ...
                      <p style="margin:0 0 32px;font-size:11pt;color:#333;line-height:1.75;">
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          <td style="border-left:3px solid #87102C;padding:0 0 0 20px;">
                            <p style="margin:0 0 6px;font-size:11pt;color:#555;font-style:italic;line-height:1.65;">
                      ...
                      <p style="margin:0;font-size:11pt;color:#333;line-height:1.75;">
                        With love and anticipation,
                      </p>
                      <p style="margin:8px 0 0;font-size:11pt;font-weight:700;color:#87102C;">The Pastoral Team</p>
