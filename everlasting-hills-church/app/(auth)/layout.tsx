export default function AuthLayout({
  ...
  return (
    <main className="min-h-screen bg-church-dark text-white selection:bg-church-maroon relative overflow-x-hidden py-12 px-4 sm:px-5">
      {/* Cinematic Background with Fade Gradients (from First Timer page) */}
      ...
      <div className="w-full max-w-md mx-auto relative z-10 flex items-center justify-center min-h-[80vh]">
        {children}
      </div>
    </main>
  );
