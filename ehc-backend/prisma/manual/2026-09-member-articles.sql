...
--
-- Applied out of band, as everything in this repository is:
--   npx prisma db execute --file prisma/manual/2026-09-member-articles.sql --schema prisma/schema.prisma
--
